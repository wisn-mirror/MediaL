...
/**
 * Created by Wisn on 2019-05-06 15:26.
 */
public class MSwipeRefreshLayout extends SwipeRefreshLayout  implements NestedScrollingChild2 {

    private static final String TAG = MSwipeRefreshLayout.class.getSimpleName();
...
//        initNested();
    ...
    public MSwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initNested();
    }
    ...
    public void stopNestedScroll(int type) {
        if(mChildHelper!=null)  mChildHelper.stopNestedScroll(type);
    }
