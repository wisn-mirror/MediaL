...
/**
 * Created by Wisn on 2019-05-03 16:51.
 */
public class LoadImageFile {
    ...
    public static File getGlideCacheFile(Context context, String url) {
        try {
            CacheKey dataCacheKey = new CacheKey(new GlideUrl(url), EmptySignature.obtain());
            Log.e("LoadImageFile", dataCacheKey.toString());
            ...
            Log.e("LoadImageFile", "safeKey:"+safeKey);

            DiskLruCache.Value value = diskLruCache.get(safeKey);
            if (value != null) {
                Log.e("LoadImageFile", "getFile:"+value.getFile(0).getAbsolutePath());
