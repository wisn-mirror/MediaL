...
public class HomeLayoutHelper implements IHomeLayout {
    ...
    private int mRadius;
    private @IHomeLayout.HideRadiusSide int mHideRadiusSide = HIDE_RADIUS_SIDE_NONE;
    ...
    public HomeLayoutHelper(Context context, AttributeSet attrs, int defAttr, View owner) {
        mContext = context;
    ...
    @Override
    public void setRadius(int radius, @IHomeLayout.HideRadiusSide int hideRadiusSide) {
    ...
    @Override
    public void setRadiusAndShadow(int radius, @IHomeLayout.HideRadiusSide int hideRadiusSide, int shadowElevation, float shadowAlpha) {
