 ...
 * @date 2016-03-27
 */
public class HomeStatusBarHelper {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(HomeDeviceHelper.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (HomeDeviceHelper.isMeizu() || (HomeDeviceHelper.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (HomeDeviceHelper.isZTKC2016()) {
            return false;
        }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (HomeDeviceHelper.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return HomeDeviceHelper.isMIUIV5() || HomeDeviceHelper.isMIUIV6() ||
                HomeDeviceHelper.isMIUIV7() || HomeDeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(HomeDeviceHelper.isZUKZ1() || HomeDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (HomeDeviceHelper.isTablet(context)
                && sStatusbarHeight > HomeDisplayHelper.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
