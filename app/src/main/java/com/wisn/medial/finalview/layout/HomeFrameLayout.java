...
public class HomeFrameLayout extends HomeAlphaFrameLayout implements IHomeLayout {
    private HomeLayoutHelper mLayoutHelper;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new HomeLayoutHelper(context, attrs, 0, this);
    ...
    @Override
    public void setRadiusAndShadow(int radius, @HomeLayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @HomeLayoutHelper.HideRadiusSide int hideRadiusSide) {
