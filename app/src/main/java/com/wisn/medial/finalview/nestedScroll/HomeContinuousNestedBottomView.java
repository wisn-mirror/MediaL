...
public interface HomeContinuousNestedBottomView extends HomeContinuousNestedScrollCommon {
     ...
     * so BottomView should tell the this info to  {@link HomeContinuousNestedScrollLayout}
     *
