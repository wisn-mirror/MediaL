...
import com.wisn.medial.finalview.helper.HomeWindowInsetHelper;

/**
 * Created by Wisn on 2019-05-13 11:08.
 */
public class HomeViewPager extends ViewPager implements IWindowInsetLayout {
    private static final int DEFAULT_INFINITE_RATIO = 100;

    private boolean mIsSwipeable = true;
    private boolean mIsInMeasure = false;
    private HomeWindowInsetHelper mQMUIWindowInsetHelper;
    ...
    public HomeViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        mQMUIWindowInsetHelper = new HomeWindowInsetHelper(this, this);
    }
    ...
    public void setAdapter(PagerAdapter adapter) {
        if (adapter instanceof HomePagerAdapter) {
            super.setAdapter(new WrapperPagerAdapter((HomePagerAdapter) adapter));
        } else {
    ...
    class WrapperPagerAdapter extends PagerAdapter {
        ...
        public WrapperPagerAdapter(HomePagerAdapter adapter) {
            mAdapter = adapter;
        }
