...
public class HomeNotchHelper {

    private static final String TAG = "HomeNotchHelper";
    ...
    public static boolean has3rdNotch(Context context){
        if (HomeDeviceHelper.isHuawei()) {
            return hasNotchInHuawei(context);
        } else if (HomeDeviceHelper.isVivo()) {
            return hasNotchInVivo(context);
        } else if (HomeDeviceHelper.isOppo()) {
            return hasNotchInOppo(context);
        } else if (HomeDeviceHelper.isXiaomi()) {
    ...
    private static Rect get3rdSafeInsetRect(Context context){
        // 全面屏设置项更改
        if (HomeDeviceHelper.isHuawei()) {
            boolean isHuaweiNotchSetToShow = HomeDisplayHelper.huaweiIsNotchSetToShowInSetting(context);
    ...
    private static Rect getRectInfoRotation0(Context context) {
        ...
        if (HomeDeviceHelper.isVivo()) {
            ...
            rect.top = HomeStatusBarHelper.getStatusbarHeight(context);
            rect.bottom = 0;
        } else if (HomeDeviceHelper.isHuawei()) {
    ...
    private static Rect getRectInfoRotation90(Context context) {
        ...
        if (HomeDeviceHelper.isVivo()) {
            ...
            rect.left = HomeStatusBarHelper.getStatusbarHeight(context);
            rect.right = 0;
        } else if (HomeDeviceHelper.isHuawei()) {
    ...
    private static Rect getRectInfoRotation180(Context context) {
        ...
        if (HomeDeviceHelper.isVivo()) {
            ...
            rect.top = 0;
            rect.bottom = HomeStatusBarHelper.getStatusbarHeight(context);
        } else if (HomeDeviceHelper.isHuawei()) {
            int[] notchSize = getNotchSizeInHuawei(context);
            rect.top = 0;
    ...
    private static Rect getRectInfoRotation270(Context context) {
        ...
        if (HomeDeviceHelper.isVivo()) {
            ...
            rect.right = HomeStatusBarHelper.getStatusbarHeight(context);
            rect.left = 0;
        } else if (HomeDeviceHelper.isHuawei()) {
            if (sHuaweiIsNotchSetToShow) {
    ...
    public static int getNotchHeightInXiaomi(Context context) {
        ...
        return HomeDisplayHelper.getStatusBarHeight(context);
    }

    public static int getNotchWidthInVivo(Context context){
        return HomeDisplayHelper.dp2px(context, 100);
    }

    public static int getNotchHeightInVivo(Context context){
        return HomeDisplayHelper.dp2px(context, 27);
    }
    ...
    public static boolean needFixLandscapeNotchAreaFitSystemWindow(View view){
       return HomeDeviceHelper.isXiaomi() && HomeNotchHelper.hasNotch(view);
    }
