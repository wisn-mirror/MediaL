...
public class HomeViewOffsetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {

    private HomeViewOffsetHelper viewOffsetHelper;

    private int tempTopBottomOffset = 0;
    private int tempLeftRightOffset = 0;

    public HomeViewOffsetBehavior() {
    }

    public HomeViewOffsetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (viewOffsetHelper == null) {
            viewOffsetHelper = new HomeViewOffsetHelper(child);
        }
