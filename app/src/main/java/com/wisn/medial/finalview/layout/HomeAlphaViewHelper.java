...
public class HomeAlphaViewHelper {
    ...
    public HomeAlphaViewHelper(@NonNull View target) {
        mTarget = new WeakReference<>(target);
//        mPressedAlpha = HomeResHelper.getAttrFloatValue(target.getContext(), R.attr.qmui_alpha_pressed);
//        mDisabledAlpha = HomeResHelper.getAttrFloatValue(target.getContext(), R.attr.qmui_alpha_disabled);
    }

    public HomeAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
        mTarget = new WeakReference<>(target);
