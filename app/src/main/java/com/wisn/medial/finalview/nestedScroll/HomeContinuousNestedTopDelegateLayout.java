...
public class HomeContinuousNestedTopDelegateLayout extends FrameLayout implements
        NestedScrollingChild2, NestedScrollingParent2, HomeContinuousNestedTopView {

    private OnScrollNotifier mScrollNotifier;
    private View mHeaderView;
    private HomeContinuousNestedTopView mDelegateView;
    private View mFooterView;
    private HomeViewOffsetHelper mHeaderViewOffsetHelper;
    private HomeViewOffsetHelper mDelegateViewOffsetHelper;
    private HomeViewOffsetHelper mFooterViewOffsetHelper;
    ...
    public HomeContinuousNestedTopDelegateLayout(@NonNull Context context) {
        this(context, null);
    }

    public HomeContinuousNestedTopDelegateLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public void setHeaderView(@NonNull View headerView) {
        ...
        mHeaderViewOffsetHelper = new HomeViewOffsetHelper(headerView);
        addView(headerView, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
    }

    public void setDelegateView(@NonNull HomeContinuousNestedTopView delegateView) {
        ...
        mDelegateViewOffsetHelper = new HomeViewOffsetHelper(view);
        // WRAP_CONTENT, the height will be handled by HomeContinuousNestedTopAreaBehavior
    ...
    public void setFooterView(@NonNull View footerView) {
        ...
        mFooterViewOffsetHelper = new HomeViewOffsetHelper(footerView);
    ...
    public HomeContinuousNestedTopView getDelegateView() {
