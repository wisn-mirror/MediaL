...
package com.download.core.listener;
...
import com.download.core.listener.assist.Listener4Assist;
import com.download.core.listener.assist.ListenerAssist;
import com.download.core.listener.assist.ListenerModelHandler;
...
public abstract class DownloadListener4 implements DownloadListener,
    ...
    @Override
    public final void downloadFromBeginning(@NonNull DownloadTask task,
    ...
    @Override
    public final void downloadFromBreakpoint(@NonNull DownloadTask task,
                                             @NonNull BreakpointInfo info) {
