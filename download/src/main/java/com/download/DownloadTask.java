...
import com.download.core.IdentifiedTask;
...
//     * @see Builder#addHeader(String, String)
     ...
     */
    @Override
    @NonNull public File getParentFile() {
    ...
    /**
     * Get the tag with its {@code key}, which you set through
     *
    ...
    /**
     * Get the tag save on this task object reference through
     *
     * @return the tag you set through
     */
    ...
    /**
     * Remove the tag with the {@code key} what you set through
     *
    ...
    /**
     * Remove the tag you set through
     */
